...
First, a heatmap in order to compare the average of certain features for the artists chosen ealier. The main goal is to get an idea of how the playlists compare on average. The most 
...
### Diving deeper into  [track-level features]
